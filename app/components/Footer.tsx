...
function FooterDisplay({ config }: { config: FooterConfig }) {
  const { showFooter, backgroundColor, textColor, linkColor, linkHoverColor, copyrightText, socialLinks, layout, padding, showBottomDivider, logoUrl, logoText, navigationLinks } = config
...
export default function Footer({ config: initialConfig = {}, showControlPanel = false, storageKey = 'footerConfig' }: FooterProps) {
